...
`,s=s.substring(p.length+1),a=!0),!a){let S=this.rules.other.nextBulletRegex(f),le=this.rules.other.hrRegex(f),ie=this.rules.other.fencesBeginRegex(f),ae=this.rules.other.headingBeginRegex(f),Re=this.rules.other.htmlBeginRegex(f),$e=this.rules.other.blockquoteBeginRegex(f);for(;s;){let Z=s.split(`
...
- **响应质量**：调整温度设置或尝试不同模型`,vt={class:"cnblogs-fullscreen"},Pt={class:"inner-wrapper"},Tt={class:"main-body"},It={class:"content-inner"},zt={class:"content-left"},Lt={class:"about-container"},Ct=["innerHTML"],Et={class:"sidebar-right"},Bt={class:"sidebar-section"},Dt={class:"author-info"},qt={class:"author-avatar"},Mt=["src"],Ot={class:"author-details"},Ht={class:"author-name"},jt={class:"author-bio"},Gt={class:"author-stats"},Qt={class:"stat"},Zt={class:"stat-number"},Nt={class:"stat"},Ut={class:"stat-number"},Vt={class:"stat"},Ft={class:"stat-number"},Wt={class:"sidebar-section"},Xt={class:"recent-posts"},Jt=["onClick"],Kt={class:"recent-post-link"},Yt={class:"post-title"},en={class:"post-count"},tn={class:"sidebar-section login-section"},nn={class:"login-prompt"},sn={class:"login-buttons"},rn={class:"login-buttons"},ln={__name:"index",setup(s){const e=oe([]),n=oe({username:"",avatar:"",bio:"",postsCount:0,articlesCount:0,commentsCount:0}),r=Me(),t=Pe();k.setOptions({gfm:!0,breaks:!0});const i=Te(()=>k.parse($t)),l=async()=>{try{const g=[...await Be.getAllCategories()||[]].sort((p,b)=>b.count-p.count);e.value=g.slice(0,5)}catch(h){console.error("获取分类数据失败:",h),De.error("获取分类数据失败")}},c=async()=>{try{if(t.user)n.value=t.user;else{const h=await qe.getUserById(1);n.value=h}}catch(h){console.error("获取用户数据失败:",h)}},a=h=>{r.push({path:"/",query:{category:h.name}})};return Ie(async()=>{await l(),await c()}),(h,o)=>{const g=Ce("router-link");return z(),I("div",vt,[u("div",Pt,[v(ze),u("div",Tt,[u("div",It,[u("div",zt,[u("div",Lt,[o[0]||(o[0]=u("h2",{class:"page-title"},"关于本项目",-1)),o[1]||(o[1]=u("p",{class:"page-subtitle"},"以下内容来自仓库根目录的 README.md，修改该文件后保存即可在开发模式下即时更新",-1)),u("article",{class:"readme-body",innerHTML:i.value},null,8,Ct)])]),u("div",Et,[u("div",Bt,[o[5]||(o[5]=u("h3",{class:"sidebar-title"},"博主信息",-1)),u("div",Dt,[u("div",qt,[u("img",{src:n.value.avatar||"https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png",alt:"博主头像",class:"avatar-img"},null,8,Mt)]),u("div",Ot,[u("h4",Ht,_(n.value.username||"访客"),1),u("p",jt,_(n.value.bio||"暂无简介"),1),u("div",Gt,[u("div",Qt,[u("span",Zt,_(n.value.postsCount||0),1),o[2]||(o[2]=u("span",{class:"stat-label"},"随笔",-1))]),u("div",Nt,[u("span",Ut,_(n.value.articlesCount||0),1),o[3]||(o[3]=u("span",{class:"stat-label"},"文章",-1))]),u("div",Vt,[u("span",Ft,_(n.value.commentsCount||0),1),o[4]||(o[4]=u("span",{class:"stat-label"},"评论",-1))])])])])]),u("div",Wt,[o[6]||(o[6]=u("h3",{class:"sidebar-title"},"热门分类",-1)),u("ul",Xt,[(z(!0),I(N,null,Le(e.value,p=>(z(),I("li",{key:p.id,class:"recent-post-item",onClick:b=>a(p)},[u("div",Kt,[u("span",Yt,_(p.name),1),u("span",en,"("+_(p.count)+")",1)])],8,Jt))),128))])]),u("div",tn,[o[12]||(o[12]=u("h3",{class:"sidebar-title"},"访问入口",-1)),U(t).token==="1"?(z(),I(N,{key:0},[u("p",nn,"欢迎回来，"+_(n.value.username)+"！",1),u("div",sn,[v(g,{to:`/dashboard/${U(t).user.id}/editor/new`,class:"login-button"},{default:D(()=>[...o[7]||(o[7]=[q("写文章",-1)])]),_:1},8,["to"]),v(g,{to:`/dashboard/${U(t).user.id}/settings`,class:"register-button"},{default:D(()=>[...o[8]||(o[8]=[q("设置",-1)])]),_:1},8,["to"])])],64)):(z(),I(N,{key:1},[o[11]||(o[11]=u("p",{class:"login-prompt"},"立即登录，发布你的第一篇博客",-1)),u("div",rn,[v(g,{to:"/login",class:"login-button"},{default:D(()=>[...o[9]||(o[9]=[q("登录",-1)])]),_:1}),v(g,{to:"/register",class:"register-button"},{default:D(()=>[...o[10]||(o[10]=[q("注册",-1)])]),_:1})])],64))])])])]),v(Ee)])])}}},on=ve(ln,[["__scopeId","data-v-ce9de4a0"]]);export{on as default};
//# sourceMappingURL=index-CiS5a8N-.js.map
